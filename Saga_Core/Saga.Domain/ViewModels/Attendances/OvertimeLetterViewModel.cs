...
public class OvertimeLetterListItem
{
...
public class OvertimeLetterForm : OvertimeLetterListItem
{
    ...
    public OvertimeLetterDto ConvertToOvertimeLetterDto()
    {
        return new OvertimeLetterDto
        {
            Key = this.Key,
...
public class OvertimeLetterDetailReport : GeneralAttendanceReportFilter
{
    ...
    public IEnumerable<OvertimeLetterDetailReportData> OvertimeLetterDetailReports { get; set; } = new List<OvertimeLetterDetailReportData>();
    ...
    public OvertimeLetterDetailReportDto ConvertToOvertimeLetterDetailReportDto()
    {
        return new OvertimeLetterDetailReportDto
        {
            EmployeeKey = this.EmployeeKey,
...
public class OvertimeLetterDetailReportData
{
